...
BINARY=prometheus-openweathermap-exporter
...
install: strip
	...
	install -m 0644 systemd/prometheus-openweathermap-exporter.service $(DESTDIR)/lib/systemd/system/

uninstall:
	/bin/rm -f $(DESTDIR)/usr/sbin/$(BINARY) $(DESTDIR)/lib/systemd/system/prometheus-openweathermap-exporter.service
