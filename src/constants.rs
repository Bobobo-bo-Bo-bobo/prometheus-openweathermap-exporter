...
pub const METRIC_WIND_SPEED_NAME: &str = "openweathermap_wind_speed_kilmeters_per_hour";
pub const METRIC_WIND_SPEED_HELP: &str = "Wind speed";
pub const METRIC_WIND_GUST_NAME: &str = "openweathermap_wind_gust_speed_kilometers_per_hour";
